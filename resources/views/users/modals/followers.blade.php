<div class="modal fade" id="followers-{{ $user->id }}">
    <div class="modal-dialog">
        <div class="modal-content">
            @if ($user->followersID->isNotEmpty())
                <div class="row justify-content-center">
                    <div class="col-8 my-2">
                        <h3 class="text-muted text-center">Followers</h3>

                        @foreach ($user->followersID as $follower)
                            <div class="row align-items-center mt-3">
                                <div class="col-auto">
                                    <a href="{{ route('profile', $follower->follower->id) }}">
                                ...
                                <div class="col ps-0 text-truncate">
                                    <a href="{{ route('profile', $follower->follower->id) }}" class="text-decoration-none text-dark fw-bold">
